...
componentDidMount() {
  ...
  render() {
	...
	<div>
		...
		<ContentVideo breakpoint="8" embed16by9 textwrapper produto="CCJ" date="25/5/2018" title="Lorem ipsum and current modern day relevance of blind text." text="O Lorem Ipsum é um texto que serve como modelo para simular conteúdo. É usado normalmente por designers na elaboração de projetos gráficos, como jornais, revistas e websites. A sua invenção remonta ao século XVI, "></ContentVideo>
		</div>
		<div className='d-block d-sm-none'>
		<ContentVideo breakpoint="12" embed16by9 textwrapper produto="CCJ" date="25/5/2018" title="Lorem ipsum and current modern day relevance of blind text." text="O Lorem Ipsum é um texto que serve como modelo para simular conteúdo. É usado normalmente por designers na elaboração de projetos gráficos, como jornais, revistas e websites. A sua invenção remonta ao século XVI, "></ContentVideo>
		</div>
